    ...
    <?php
				...
				<div class='row'>
					<div class='col-lg-6 col-md-6'>
						<img class='img-responsive' src='im/article/4/3.jpg' alt='' />
					</div>
					<div class='col-lg-6 col-md-6'>
						<img class='img-responsive' src='im/article/4/1.jpg' alt='' />
					</div>
				</div>
				...
				<div class='row'>
					<div class='col-lg-4 col-md-4'>
						<img class='img-responsive' src='im/article/4/7.jpg' alt='' />
					</div>
					<div class='col-lg-4 col-md-4'>
						<img class='img-responsive' src='im/article/4/6.jpg' alt='' />
					</div>
					<div class='col-lg-4 col-md-4'>
						<img class='img-responsive' src='im/article/4/5.jpg' alt='' />
					</div>
				</div>
