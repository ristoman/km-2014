<?php
	...
	$text="
		...
		<div class='col-lg-6 col-md-6'>
			<img class='img-responsive' src='im/article/1/2.jpg' alt='' />
		</div>
		</div>
		...
		<div class='row'>
		<div class='col-lg-6 col-md-6'>
		<img class='img-responsive' src='im/article/1/3.jpg' alt='' />
		</div>
		<div class='col-lg-6 col-md-6'>
		<img class='img-responsive' src='im/article/1/4.jpg' alt='' />
		</div>
		<div class='col-lg-6 col-md-6'>
		<img class='img-responsive' src='im/article/1/5.jpg' alt='' />
		</div>
		<div class='col-lg-6 col-md-6'>
		<img class='img-responsive' src='im/article/1/6.jpg' alt='' />
		</div>
		</div>
		...
		<div class='row'>
		<div class='col-lg-6 col-md-6'>
			<img class='img-responsive' src='im/article/1/7.jpg' alt='' />
		</div>
		<div class='col-lg-6 col-md-6'>
			<img class='img-responsive' src='im/article/1/8.jpg' alt='' />
		</div>
		<img class='img-responsive' src='im/article/1/9.jpg' alt='' />
		</div>
	";
